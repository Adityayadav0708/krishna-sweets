      ...
      <section className={styles.foundation} id="foundation">
        <Container>
          <SectionHeading
            ...
            title="A palette with warmth in its bones."
            body="Creamy ivory carries the hospitality. Maroon holds the heritage. Antique gold brings ceremony, while pistachio keeps the system fresh and distinctly culinary."
          />
      ...
      <section className={styles.typeSection}>
        <Container className={styles.typeGrid}>
          <div>
            <SectionHeading
              eyebrow="Typography"
              title="Old-world grace. Modern clarity."
              body="Cormorant Garamond gives the brand its expressive, editorial voice. Manrope keeps product details, filters and ordering beautifully clear."
            />
      ...
      <section className={styles.valuesSection}>
        <Container>
          <SectionHeading
            ...
            title="Made to feel as considered as the mithai."
            align="center"
          />
